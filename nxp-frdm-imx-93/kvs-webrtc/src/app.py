...
def detect_video_device() -> Optional[str]:
    # On the NXP FRDM i.MX93 both /dev/video0 and /dev/video1 correspond to the
    # USB camera. We check for "usb" in the resolved sysfs path to reliably select
    # the USB camera regardless of which port it is plugged into.
    try:
