...
curl -sSL -o app.py "https://raw.githubusercontent.com/avnet-iotconnect/iotc-python-lite-sdk-demos/main/nxp-frdm-imx-93//dms-demo/src/app.py" || {
...
echo "Download and processing of models takes approximately 10 minutes"
if [[ "$model_choice" == "y" || "$model_choice" == "Y" ]]; then
    curl -sSL -o /usr/bin/eiq-examples-git/download_models.py "https://raw.githubusercontent.com/avnet-iotconnect/iotc-python-lite-sdk-demos/main/nxp-frdm-imx-93/dms-demo/src/download_models.py" || {
        echo "Error: Failed to resolve host raw.githubusercontent.com. Please check your network and DNS settings."
        exit 1
        }
