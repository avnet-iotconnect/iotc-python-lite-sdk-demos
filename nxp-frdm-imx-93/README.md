...
5. Run the install script which will automate the installation of the i.MX eIQ Demo by perform the following actions:
   ...
   * Start the interactive /IOTCONNECT onboarding script
   ...
   ```
   cd /home/weston
   curl -sOJ 'https://raw.githubusercontent.com/avnet-iotconnect/iotc-python-lite-sdk-demos/main/nxp-frdm-imx-93/dms-demo/scripts/imx93-setup.sh' && bash ./imx93-setup.sh
   ```
