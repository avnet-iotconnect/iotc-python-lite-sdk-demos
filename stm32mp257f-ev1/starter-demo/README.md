...
This guide will help you create and deliver a package based on the IoTConnect Starter Demo (random-integer telemetry) to the STM32MP257F-EV1.

>[!IMPORTANT]
> If you have not yet followed the [IoTConnect quickstart guide for this board](https://github.com/avnet-iotconnect/iotc-python-lite-sdk-demos/blob/main/stm32mp257f-ev1/README.md), complete that first and then return here to pick up on Step 1.
...
## 2. Customize Package
Inside of the cloned repo (```iotc-python-lite-sdk-demos```), navigate to the ```stm32mp257f-ev1/starter-demo/src/``` directory:
```
