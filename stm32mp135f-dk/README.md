...
/IOTCONNECT can be installed on this devices via two different methods:
1. Manually using the Python SDK and configuration
2. Using AWS Greengrass lite

Expand the section below corresponding to your preferred method:

<details>
<summary>Setup using AWS greengrass lite</summary>
</details>

<details>
<summary>Setup without AWS greengrass lite</summary>
