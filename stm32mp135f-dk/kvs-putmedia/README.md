...
Upgrades the /IOTCONNECT Starter Demo on the STM32MP135F-DK to the AWS Kinesis Video Streams (KVS) PutMedia video streaming demo.
...
2. Edit files in `stm32mp135f-dk/kvs-putmedia/src/` as needed.

3. To rebuild with the existing pre-built libraries, run:
   ```bash
   cd stm32mp135f-dk/kvs-putmedia
