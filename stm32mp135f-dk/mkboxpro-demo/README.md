...
Upgrades the /IOTCONNECT Starter Demo on the STM32MP135F-DK to the MKBOXPRO BLE sensor pack demo.
...
This demo streams BLE sensor telemetry from a SensorTile.box PRO (MKBOXPRO) sensor pack to /IOTCONNECT via the STM32MP135F-DK. Sensor data appears in real time under the **Live Data** tab of your device in the /IOTCONNECT platform.
...
```bash
cd /opt/demo
wget -O package.tar.gz https://raw.githubusercontent.com/avnet-iotconnect/iotc-python-lite-sdk-demos/main/stm32mp135f-dk/mkboxpro-demo/package.tar.gz
...
2. Edit files in `stm32mp135f-dk/mkboxpro-demo/src/` as needed.

3. Rebuild the package:
   ```bash
   cd stm32mp135f-dk/mkboxpro-demo
