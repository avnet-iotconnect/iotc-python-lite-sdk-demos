...
This guide will help you upgrade the basic /IOTCONNECT Starter Demo on the STM32MP135F-DK to the standard PROTEUS sensor
...
```stm32mp135f-dk/proteus-standard-demo/src/``` directory:
