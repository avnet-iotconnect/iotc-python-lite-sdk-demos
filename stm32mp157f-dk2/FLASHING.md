# Flashing a fresh Yocto image to your STM32MP157F-DK2

# Introduction
This simple guide will help you download all the necessary files for flashing a fresh stock image to a STM32MP157F-DK2, and then flash the image to the board.
