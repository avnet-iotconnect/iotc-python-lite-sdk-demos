...
This guide will help you create and deliver a package based on the IoTConnect Starter Demo (random-integer telemetry) to the STM32MP157F-DK2.
...
## 2. Customize Package
Inside of the cloned repo (```iotc-python-lite-sdk-demos```), navigate to the ```stm32mp157f-dk2/starter-demo/src/``` directory:
```
cd ./stm32mp157f-dk2/starter-demo/src/
```
