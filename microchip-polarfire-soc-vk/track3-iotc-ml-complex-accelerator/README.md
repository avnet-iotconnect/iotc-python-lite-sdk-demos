...
2. Download the Complex Neural Network Accelerator FPGA job file [here](https://s3.us-east-1.amazonaws.com/avnetpublicaccess/large-repo-files/MPFS_VIDEO_KIT_TSN_DESIGN_2025_03.job) (right-click, "save as").
...
```bash
wget -O /opt/demo/package.tar.gz https://raw.githubusercontent.com/avnet-iotconnect/iotc-python-lite-sdk-demos/main/microchip-polarfire-soc-vk/track3-iotc-ml-complex-accelerator/package.tar.gz
```
