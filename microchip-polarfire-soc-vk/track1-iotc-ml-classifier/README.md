...
2. Download the Track 1 FPGA job file [here](assets/fpga-job/MPFS_VIDEO_KIT_TSN_DESIGN_2025_03.job) (right-click, "save as").
...
2. Download dashboard template [here](mchp-classifier-dashboard.json). (right-click and "save link as"), then click **Import Dashboard** and upload the JSON file.
