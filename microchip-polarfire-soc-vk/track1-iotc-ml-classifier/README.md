...
2. Download the Template Correlation Classifier FPGA job file [here](https://s3.us-east-1.amazonaws.com/avnetpublicaccess/large-repo-files/MPFS_VIDEO_KIT_TSN_DESIGN_2025_03.job) (right-click, "save as").
