...
This guide will help you create and deliver a package based on the IoTConnect Starter Demo (random-integer telemetry) to the Microchip SAMA5D27.

>[!IMPORTANT]
> If you have not yet followed the [IoTConnect quickstart guide for this board](https://github.com/avnet-iotconnect/iotc-python-lite-sdk-demos/blob/main/microchip-sama5d27/README.md), complete that first and then return here to pick up on Step 1.
...
## 2. Customize Package
Inside of the cloned repo (```iotc-python-lite-sdk-demos```), navigate to the ```microchip-sama5d27/starter-demo/src/``` directory:
```
