# WiFi Setup Guide for NXP FRDM-i.MX95 with Yocto

This guide explains how to set up and connect WiFi on the NXP FRDM-i.MX95 running Yocto. It includes instructions for
...
1. NXP FRDM-i.MX95 development board running Yocto.
