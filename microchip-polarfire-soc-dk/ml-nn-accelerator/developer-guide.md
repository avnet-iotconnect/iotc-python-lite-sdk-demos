# Developer Guide: /IOTCONNECT Tiny-NN Accelerator

This is the full source-build flow for the **Tiny-NN Accelerator** demo.
...
powershell -ExecutionPolicy Bypass -File `
  C:\dev\MCHP\iotc-python-lite-sdk-demos\microchip-polarfire-soc-dk\ml-nn-accelerator\tools\fetch-tinyml-nn-module.ps1 `
...
- The branch/tag in `RepoZipUrl` must already contain:
  - `microchip-polarfire-soc-dk/ml-nn-accelerator/assets/smarthls-module/tinyml_nn`
...
powershell -ExecutionPolicy Bypass -File `
  C:\dev\MCHP\iotc-python-lite-sdk-demos\microchip-polarfire-soc-dk\ml-nn-accelerator\tools\fetch-tinyml-nn-module.ps1 `
  -ReferenceDesignRoot C:\dev\MCHP\Libero25-3\polarfire-soc-discovery-kit-reference-design-2025.07 `
  -LocalModulePath C:\dev\MCHP\iotc-python-lite-sdk-demos\microchip-polarfire-soc-dk\ml-nn-accelerator\assets\smarthls-module\tinyml_nn
```
...
## 6. Integrate Tiny-NN Accelerator
...
- Job:
  - `ml-nn-accelerator\assets\fpga-job\MPFS_DISCOVERY_KIT.job`
- ELFs:
  - `ml-nn-accelerator\src\runtimes\tinyml_nn.no_accel.elf`
  - `ml-nn-accelerator\src\runtimes\tinyml_nn.accel.elf`
