...
# Make the script re-runnable: remove prior AXI2AXI instances/component if present.
catch {sd_delete_instances -sd_name $hls_sd_name -instance_names {"AXI2AXI_TO_HLS"}}
catch {sd_delete_instances -sd_name $hls_sd_name -instance_names {"AXI2AXI_FROM_HLS"}}
catch {delete_component -component_name {AXI2AXI}}
