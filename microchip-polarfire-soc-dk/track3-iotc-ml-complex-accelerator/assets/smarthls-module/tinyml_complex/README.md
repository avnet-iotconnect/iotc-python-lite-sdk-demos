# tinyml_complex SmartHLS Module (Track 3)

This is a starter SmartHLS module for the complex-model workshop.
...
This starter increases model compute versus earlier tracks by using:
