...
2. Download and import the device template [here](https://raw.githubusercontent.com/avnet-iotconnect/iotc-python-lite-sdk-demos/main/microchip-polarfire-soc-dk/ml-classifier/microchip-polarfire-ml-template.json). (right-click and "save link as")
3. Save.
