...
2. Download the Simple Neural Network Accelerator FPGA job file [here](https://s3.us-east-1.amazonaws.com/avnetpublicaccess/large-repo-files/MPFS_DISCOVERY_KIT_SIMPLE_NN.job) (right-click, "save as").
...
2. Click [mchp-simple-nn-dashboard.json](mchp-simple-nn-dashboard.json) to open the dashboard template on GitHub, then click the download button to save it. Click **Import Dashboard** and upload the downloaded file.
...
```bash
wget -O /opt/demo/package.tar.gz https://raw.githubusercontent.com/avnet-iotconnect/iotc-python-lite-sdk-demos/main/microchip-polarfire-soc-dk/ml-simple-nn-accelerator/package.tar.gz
```
