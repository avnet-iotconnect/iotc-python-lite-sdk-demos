...
### 5.2 Simple Neural Network Accelerator: Compact Fixed-Point NN-Style Classifier

Implementation file:

- `ml-simple-nn-accelerator/assets/smarthls-module/tinyml_nn/main_variations/main.fifo.cpp`
