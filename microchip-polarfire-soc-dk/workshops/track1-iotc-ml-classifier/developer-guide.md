...
- FPGA job:
  - `track1-iotc-ml-classifier\assets\fpga-job\MPFS_DISCOVERY_KIT.job`
- ELFs:
  - `track1-iotc-ml-classifier\src\runtimes\invert_and_threshold.no_accel.elf`
  - `track1-iotc-ml-classifier\src\runtimes\invert_and_threshold.accel.elf`
