...
2. Download FPGA project [link](https://github.com/avnet-iotconnect/iotc-python-lite-sdk-demos/blob/main/microchip-polarfire-soc-dk/workshops/track3-iotc-ml-classifier/assets/fpga-job/MPFS_DISCOVERY_KIT.job)(right-click, "save as")
...
```bash
wget https://github.com/avnet-iotconnect/iotc-python-lite-sdk-demos/blob/main/microchip-polarfire-soc-dk/workshops/track3-iotc-ml-complex-accelerator/package.tar.gz
```
...
2. Click **Import Dashboard** and upload the JSON file [../templates-iotconnect/mchp-track3-dashboard-template.json](https://raw.githubusercontent.com/avnet-iotconnect/iotc-python-lite-sdk-demos/refs/heads/main/microchip-polarfire-soc-dk/workshops/templates-iotconnect/mchp-track3-dashboard-template.json).
