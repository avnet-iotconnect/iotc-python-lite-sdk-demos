...
DATA_WIDTH:64 MASTER0_DATA_WIDTH:64\
  SLAVE0_START_ADDR:0x70100000  SLAVE0_END_ADDR:0x70100007 SLAVE0_DATA_WIDTH:64 SLAVE0_TYPE:1\
  MASTER0_READ_SLAVE0:true MASTER0_WRITE_SLAVE0:true\
  SLAVE1_START_ADDR:0x70000000 SLAVE1_DATA_WIDTH:64 SLAVE1_TYPE:0 SLAVE1_END_ADDR:0x7008603f\
...
sd_instantiate_hdl_core -sd_name {FIC_0_PERIPHERALS} -hdl_core_name {tinyml_complex_soc_cycle_counter} -instance_name {soc_cycle_counter_inst}
