...
source $hlsPrjAbsPath/hls_output/scripts//libero/create_hdl_plus_tinyml_accel_top.tcl
source $hlsPrjAbsPath/hls_output/scripts//libero/create_hdl_plus_soc_cycle_counter.tcl
