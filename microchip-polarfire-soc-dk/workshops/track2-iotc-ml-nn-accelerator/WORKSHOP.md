...
2. Download dashboard template for this project [here](https://raw.githubusercontent.com/avnet-iotconnect/iotc-python-lite-sdk-demos/main/microchip-polarfire-soc-dk/workshops/templates-iotconnect/mchp-track2-dashboard-template.json). (right-click and "save link as"), then click **Import Dashboard** and upload the JSON file.
