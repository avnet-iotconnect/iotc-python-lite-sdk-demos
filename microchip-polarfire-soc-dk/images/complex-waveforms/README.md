...
- `complex_class2.svg`: triangle + saw mix
- `complex_class3.svg`: burst train + triangle
- `complex_class4.svg`: damped ringing + fast triangle
- `complex_class5.svg`: impulse + saw composite
